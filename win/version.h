...
#define PRODUCT_NAME           "gossipbox" // 产品名称
...
#define INTERNAL_NAME          "gossipbox.exe"
#define FILE_DESCRIPTION       "gossipbox for local network communication"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "gossipbox.exe"    // 原始文件名
